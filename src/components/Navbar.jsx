      ...
      <div className="hidden sm:flex items-center justify-between w-[80%]">
        <form className="flex items-center relative">
          <input
            ...
            value={q}
            className="min-w-72 h-10 bg-white font-medium !text-md p-5"
            onChange={(e) =>
          ...
          <a
            href="/filter"
            className="absolute text-xl top-1/2 right-5 translate-x-1/2 -translate-y-1/2 !text-[#3a3951]"
          >
        ...
        <button className="rounded-md font-bold w-20 h-10 bg-red-50 ">
          Login
        </button>
      </div>
    </nav>
